...
function runMotherSiteMotion(viewName, container) {
    ...
    motherSiteMotionContext = window.gsap.context(() => {
        ...
        if (viewName === 'HomeHub' && homeHero) {
            ...
            tl.from('.home-eyebrow', { autoAlpha: 0, y: 14, duration: 0.32 })
                .from('.home-hero-kicker', { autoAlpha: 0, y: 16, duration: 0.32 }, '-=0.18')
                .from('.home-hero h1', { autoAlpha: 0, y: 22, duration: 0.45 }, '-=0.12')
        ...
        if (window.ScrollTrigger && sections.length) {
    ...
    const resourceLinks = [
        {
            ...
            kicker: '課程網站',
            title: 'AI新手村',
            desc: '醫護人員 AI 實作講義網站版，含提示詞、NotebookLM 與 Codex 範例。',
            variant: 'warning'
        },
        {
            ...
            <section class="home-hero">
                <div class="home-hero-grid">
                    ...
                    <div class="home-hero-copy">
                        ...
                        <p class="home-hero-lead">它不是電子佈告欄，也不是把 guideline 原文整包倒進來；比較像核醫科值班桌旁那位記性很好、講話不囉嗦、你一慌就知道去哪一頁找答案的同事。</p>
                        <div class="prose">
                            <p>站內主體照工作內容分區，不是照玄學分。PET、心臟、內分泌、骨骼與腎泌尿、胃腸肝膽、神經與肺部感染，外加治療單元與核醫小學堂，基本上就是把核醫科一天會遇到的關卡，拆成比較不會讓人腦袋當機的順序。</p>
                            <p>每個檢查頁面會放適應症、前置條件、時間架構、影像重點和實際操作時最容易卡住的地方。你不用先背完整本 guideline，先知道病人能不能做、現在該做哪一步、做完要注意什麼，通常就已經贏過昨天那個只靠印象硬撐的自己。</p>
                            <p>除了檢查內容，這裡也收了很多工作支援頁：像病人溝通與衛教、藥物與劑量工具、輻射防護、文件與品質管理，都是平常覺得「等等再查」但一出事就會想立刻打開的東西。這個網站想提供的，不是知識的氣氛，而是能真的救場的資訊。</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="i131-hero">
                ...
                <div class="i131-hero-grid is-panel-only">
                    <aside class="i131-hero-panel">
                        ...
                        <div class="i131-panel-block">
                            <span class="i131-panel-kicker">住院與放行關鍵點</span>
