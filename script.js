            ...
            <section class="home-hero">
                <div class="home-hero-copy">
                    ...
                    <div class="prose">
                        ...
                        <p>如果你是第一次使用，建議先把左側分類看過一輪。現在大致分成幾個區塊：PET、心臟、內分泌、骨骼與腎泌尿、胃腸肝膽、神經與肺部感染，另外還有核醫小學堂、治療單元，以及工具與外部連結。每個檢查頁會放適應症、時間架構、判讀重點，也會逐步補上給放射師與核醫醫師使用的技術 protocol 摘要，方便在上機前或判讀前快速核對。</p>
                        ...
                        <p>工具與外部連結的部分，也盡量收成固定入口，避免每次都重新找網址。民眾版核醫衛教是給病人與家屬閱讀的版本，內容和本站的專業頁面分開；AI 文字辨識適合處理文件或影像上的文字擷取；I-131 病房排程是為了住院治療流程快速確認節奏；核醫排檢 DEMO 可以當作流程展示或初步說明；PET 智慧排程比較適合安排 PET 檢查時快速整理條件；台灣核醫學會則是回查學會公告、課程與正式專業資訊的入口。</p>
                        <ul>
                            <li><strong>民眾版核醫衛教：</strong>提供病人與家屬閱讀的簡化說明，適合在衛教或電話溝通時直接分享。</li>
                            <li><strong>AI 文字辨識：</strong>協助把圖片或文件中的文字快速抓出來，適合整理資料時搭配使用。</li>
                            <li><strong>I-131 病房排程：</strong>用來確認住院日期、病房安排與治療節奏，避免排程來回重算。</li>
                            <li><strong>核醫排檢 DEMO：</strong>適合做流程展示，或拿來快速說明排檢邏輯。</li>
                            <li><strong>PET 智慧排程：</strong>整理 PET 檢查安排時常見的時間與流程條件，適合排程前先核對。</li>
                            <li><strong>台灣核醫學會：</strong>回查學會公告、研討會與正式專業消息時最直接的入口。</li>
                        </ul>
